...
{
    public partial class frmBinomial : Form
    {
        ...
        private void btnObtener_Click(object sender, EventArgs e)
        {
            if (VerificarTextBoxLlenos())
            {
                ...
                if (resultadoPob == "Infinita")
                {
                    ...
                    {
                        MostrarMensajeError("P no puede ser 0 ni mayor o igual a 1 (0.01-0.99)");
                    }
                }

                else if(resultadoPob == "Finita")
                {
                    if (validarCantidad())
                    {
                        if (validarP())
                ...
                else if (resultadoPob == "Hipergeométrica")
                {
                    MostrarMensajeError("Este problema se debe resolver con distribución hipergeométrica");
                    frmHipergeometrica frmHipergeometrica = new frmHipergeometrica();

                    frmHipergeometrica.txtPoblacion.Text = txtPoblacion.Text;
                    frmHipergeometrica.txtN.Text = txtN.Text;
                    frmHipergeometrica.txtX.Text = txtX.Text;
        ...
        public void valPob()
        {
            ...
            if (!string.IsNullOrWhiteSpace(txtPoblacion.Text))
            {
                ...
                if (porcentaje <= 5.00m)
                {
                    resultadoPob = "Infinita";
                }
                else if(porcentaje > 5.00m && porcentaje <= 20.00m)
                {
                    resultadoPob = "Finita";
                }
                else if(porcentaje > 20.00m)
                {
                    resultadoPob = "Hipergeométrica";
                }
            }
            else
            {
        ...
        //Función para generar el gráfico de distribución binomial
        private void GenerarGrafico()
        {
            ...
            Series series = new Series("Distribución Binomial");
            ...
            for (int i = 0; i <= formulas.n; i++)
            {
                ...
                double probabilidad = formulas.formBinomial();
        ...
        {
            decimal p = decimal.Parse(txtP.Text);
        ...
        private void CalcularDatosFinitos()
        {
            ...
            labelFC.Visible = true;
            txtFC.Visible = true;

            // Calcular la distribución binomial
            double result = formulas.formBinomial();
            txtResultadoBinomial.Text = result.ToString();

            // Mostrar la media
            double med = formulas.getMedia();
            txtMedia.Text = med.ToString();

            // Mostrar el tipo de población
            txtPob.Text = resultadoPob;

            // Mostrar la desviación estándar
            double desv = formulas.calcDesvFi();
            txtDesv.Text = desv.ToString();

            //Mostrar el Factor de Corrección
            double fac = formulas.calcFc();
            txtFC.Text = fac.ToString();
        ...
        private void CalcularDatosInfinitos()
        {
            formulas.n = int.Parse(txtN.Text);
            formulas.x = int.Parse(txtX.Text);
            formulas.p = double.Parse(txtP.Text);
